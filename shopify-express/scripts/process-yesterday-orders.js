...
async function run() {
  ...
  console.log(`Yesterday's local date: ${yesterdayStr}`);
  ...
  // Filter for orders created yesterday in local time
  ...
  console.log(`Found ${yesterdayOrders.length} orders created on yesterday (${yesterdayStr}).`);
  ...
  console.log(`  Total Yesterday Orders Found: ${yesterdayOrders.length}`);
