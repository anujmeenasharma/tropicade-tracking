...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      {/* Hero Section */}
      <section className="relative px-6 pt-32 pb-24 sm:pt-48 sm:pb-32 lg:px-8 flex flex-col items-center justify-center min-h-[90vh]">
        <motion.div
          style={{ opacity }}
        ...
        >
          ...
          <motion.div
            ...
            className="mt-16 flex items-center justify-center gap-2 text-sm text-neutral-500"
          >
            <Link href="/admin" className="hover:text-foreground transition flex items-center gap-1">
