...
const genericEventsTemplate = [
    ...
    { dayOffset: 17, dayLabel: 18, time: '07:44 AM', location: (city, country) => country, title: 'Arrival at Destination Hub', description: 'Shipment arrived at the destination country sorting facility.', eventCode: 'IT-ARR-IN', warning: false },
    { dayOffset: 18, dayLabel: 19, time: '02:15 PM', location: (city, country) => country, title: 'In Transit to Local Distribution Center', description: 'The shipment is moving within the destination country toward the local delivery facility.', eventCode: 'IT-DOM-TRANSIT', warning: false },
    { dayOffset: 19, dayLabel: 20, time: '07:22 PM', location: (city, country) => `${city}, ${country}`, title: 'Local Distribution Center', description: 'Shipment transferred to local delivery unit.', eventCode: 'IT-LOCAL-SORT', warning: false },
