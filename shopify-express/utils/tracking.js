...
// Business days adder in plain Javascript
...
function getIsoCode(countryName) {
  return countriesToIso[countryName] || (countryName ? countryName.substring(0, 2).toUpperCase() : 'US');
}

// Standard tracking event templates
...
function generateTrackingTimeline(startDateString, destinationCountry, destinationCity) {
  ...
  for (const template of genericEventsTemplate) {
    ...
    // Format date as "Month Day, Year" using standard JS Locale methods
